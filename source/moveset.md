...
Generally not used for mobbing due to its small AoE, and also generally not used for bossing since [Wulfen Raid](#wulfen-raid) deals more DPS (both tapped and held).
